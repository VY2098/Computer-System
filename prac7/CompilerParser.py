...
class CompilerParser :
    ...
    def compileSubroutine(self):
        ...
        sub_rout_tree.addChild(self.mustBe("symbol", self.current().getValue()))

        while not self.have("symbol", ")"):
            param_list_tree = ParseTree("parameterList", "")
            sub_rout_tree.addChild(param_list_tree)
        
        sub_rout_tree.addChild(self.mustBe("symbol", ")"))

        sub_rout_body_tree = ParseTree("subroutineBody", "")
        sub_rout_tree.addChild(sub_rout_body_tree)
    ...
    def compileSubroutineBody(self):
        ...
        while not self.have("symbol", "}"):
            ...
            sub_rout_body_tree.addChild(var_dec_tree)
